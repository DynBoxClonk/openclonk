...
private func InitializePlayer(int plr)
{
	...
	// Knowledge
	GivePlayerKnowledge(plr, [ToolsWorkshop, Foundry, Flagpole, Elevator, Armory, ChemicalLab, Lorry, Pickaxe, Axe, Hammer, Shovel, Barrel, Dynamite, DynamiteBox, Loam, Bucket, Sword, Metal, GoldBar, Balloon, Boompack, GrappleBow, WindBag, Pipe, Pump, PowderKeg, Ropeladder, Bow, Arrow, Club, IronBomb, Javelin, Shield, InventorsLab, Sawmill, BombArrow, FireArrow, GrenadeLauncher, Torch, WoodenBridge, Basement]);
	return true;
}
