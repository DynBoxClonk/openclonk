...
func InitializeObjects()
{
	...
	StoneDoor001->SetPlayerViewOnSignalChange(true);
	...
	StoneDoor002->SetPlayerViewOnSignalChange(true);
	...
	StoneDoor003->SetPlayerViewOnSignalChange(true);
	...
	StoneDoor004->SetPlayerViewOnSignalChange(true);
	...
	StoneDoor005->SetPlayerViewOnSignalChange(true);
	...
	StoneDoor006->SetPlayerViewOnSignalChange(true);
	...
	StoneDoor007->SetPlayerViewOnSignalChange(true);
	...
	StoneDoor008->SetPlayerViewOnSignalChange(true);
	...
	g_last_stone_door->SetPlayerViewOnSignalChange(true);
	...
	StoneDoor009->SetPlayerViewOnSignalChange(true);
	...
	StoneDoor010->SetPlayerViewOnSignalChange(true);
